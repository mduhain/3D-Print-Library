...
module top(){
    $fn=100;
    cylinder(d=33,h=5,$fn=200);
    translate([0,0,5]){cylinder(d=15.85,h=6);}
    translate([0,0,11]){cylinder(d1=15.85,d2=14.9,h=0.5);}
    translate([0,0,11.5]){cylinder(d=14.9,h=5.5);}
    translate([0,0,17]){cylinder(d1=14.9,d2=15.85,h=0.5);}
    translate([0,0,17.5]){cylinder(d=15.8,h=3.5);}
    translate([0,0,21]){cylinder(d1=15.85,d2=14.9,h=0.5);}
}
...
module neg(){
    ...
    translate([50,16.5,28.4]){
        rotate([0,-45,0]){
            arch();
        }
    }
    translate([33.3,6.7,3]){
        rotate([0,-45,0]){
            cube([5,19.6,5]);
            }
        }
    ...
    translate([-5,6,16]){
        rotate([0,90,0]){
            MetricCountersunkBolt(7.1,22, tolerance=0.4);
            //cylinder(h=10,d=6.3,$fn=40);
        }
    }
    translate([-01,6,16]){
        rotate([0,90,0]){
    ...
    translate([-4.5,16.5,33]){
        rotate([0,90,0]){
            MetricCountersunkBolt(7.1,12, tolerance=0.4);
        }
    }
    translate([22.5,-3,-0.1]){
            rotate([0,0,0]){
                cube([3,42,3]);
                }
            }
...
////arrow indicator
//translate([32.7,16.5,5.2]){
//    rotate([0,-135,0]){
//        cylinder(d=4,h=2,$fn=3);
//    }
//}
