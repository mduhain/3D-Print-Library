...
module md_main() {
    translate([0,0,0]){
        cylinder(d=12.8, h=40, $fn=80);
    }
    translate([0,0,40]){
        rotate([0,0,0,]){
            cylinder (d1=12.8,d2=6,h=10,$fn=80);
        }
    }
...
module md_neg() {
    ...
    translate([-16,0,30]){
        rotate([0,90,0]){
            MetricCountersunkBolt(7.1, 16, tolerance=0.4);
        }
    }
    translate([0,0,30]){
        rotate([0,90,0]){
            cylinder(h=15, d=7.5, $fn=60);
        }
    }
    translate([0,-7,12]){
        rotate([-90,0,0]){
            cylinder(d=3,h=14,$fn=40);
        }
    }
    translate([6.5,0,30]){
        rotate([0,90,0]){
            cylinder(h=6,d=9.5,$fn=100);
        }
    }
    //bottom screw
    translate([0,0,-4]){
...
translate([1.2,-2.5,49]){
    rotate([0,0,0]){
        cube([0.6,5,1]);
    }
}
translate([-1.8,-2.5,49]){
    rotate([0,0,0]){
        cube([0.6,5,1]);
    }
}
