...
module md_neg() {
    ...
    // POST HOLES
    translate([11,9.9,-2.5]){
        rotate([0,0,0]){
            cylinder($fn=100,h=25,d=13);
        }
    }
    translate([27.1,22,9.9]){
        rotate([90,0,0]){
            cylinder($fn=100,h=25,d=13
            );
        }
...
//    translate([-2,7.9,7.9]){
//        rotate([0,90,0]){
//            cylinder($fn=6,d=11,h=5);
//        }
//    }
//    
//    translate([35,7.9,7.9]){
//        rotate([0,90,0]){
//            cylinder($fn=6,d=11,h=5);
//        }
//    }
...
//    translate([0,7.9,7.9]){
//        rotate([0,90,0]){
//            cylinder(d=6.25,h=10);
//        }
//    }
//    translate([30,7.9,7.9]){
//        rotate([0,90,0]){
//            cylinder(d=6.25,h=10);
//        }
//    }
    ...
    //SCREW THREAD
    translate([-5.5,9.9,9.9]){
        rotate([0,90,0]){
            MetricCountersunkBolt(7.1, 12, tolerance=0.4);
        }
    }
    
    translate([43.5,9.9,9.9]){
        rotate([0,-90,0]){
            MetricCountersunkBolt(7.1, 12, tolerance=0.4);
        }
    }
    ...
    // NCIE SHROT EDGE
//    translate([20.8,-10,-10]) {
//        md_inv_sphere();
//    }
//    
//    translate([17.2,30,-10]) {
//        rotate([0,0,-180]) {
//            md_inv_sphere();
//        }
//    }
